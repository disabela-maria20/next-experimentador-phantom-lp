        ...
        <>
            <form className="grid grid-cols-1" name="" id="" onSubmit={handleSubmit(onSubmit)}>
                <div className="pb-26">
                    ...
                    {errors.email && <span className="md:text-13 tm:text-10 text-red leading-1">{errors.email.message}</span>}
                </div>
                <div>
                    ...
                    {errors.aceito && <span className="md:text-13 tm:text-10 text-red leading-1">{errors.aceito.message}</span>}
                </div>
                <div>
