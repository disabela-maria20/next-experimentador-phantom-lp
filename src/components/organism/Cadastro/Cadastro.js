            ...
            <div className="rounded-medium bg-white p-38 shadow-xl">
                ...
                <form className="text-purple tm:text-15 md:text-18" onSubmit={handleSubmit(onSubmit)}>
                    <div className="grid tm:grid-cols-1 md:grid-cols-6 gap-15">
                        <label className="text-purple tm:text-15 md:text-18 col-span-6" htmlFor="nome">Nome Completo
                            ...
                            {errors.nome && <span className="md:text-13 tm:text-10 text-red leading-title">{errors.nome.message}</span>}
                        </label>
                        <label className="text-purple tm:text-15 md:text-18 tm:col-span-6 md:col-span-4" htmlFor="email">E-mail
                            ...
                            {errors.email && <span className="md:text-13 tm:text-10 text-red leading-title">{errors.email.message}</span>}
                        </label>
                        <label className="text-purple tm:text-15 md:text-18 tm:col-span-6 md:col-span-2" htmlFor="cpf">CPF
                            ...
                            {errors.cpf && <span className="md:text-13 tm:text-10 text-red leading-title">{errors.cpf.message}</span>}
                        </label>
                        <label className="text-purple tm:text-15 md:text-18 tm:col-span-6 md:col-span-3" htmlFor="telefone">Telefone
                            ...
                            {errors.telefone && <span className="md:text-13 tm:text-10 text-red leading-title">{errors.telefone.message}</span>}
                        </label>
                        <label className="text-purple tm:text-15 md:text-18 tm:col-span-6 md:col-span-3" htmlFor="cep">CEP <p className="tm:text-10 hover:underline inline font-semibold"><Link href="https://buscacepinter.correios.com.br/app/endereco/index.php"><a target="_blank" rel="noreferrer">Não sabe o CEP?</a></Link></p>
                            ...
                            {errors.cep && <span className="md:text-13 tm:text-10 text-red leading-title">{errors.cep.message}</span>}
                        </label>
                        <label className="text-purple tm:text-15 md:text-18 tm:col-span-6 md:col-span-3" htmlFor="endereco">Endereço
                            ...
                            {errors.endereco && <span className="md:text-13 tm:text-10 text-red leading-title">{errors.endereco.message}</span>}
                        </label>
                        <label className="text-purple tm:text-15 md:text-18 tm:col-span-6 md:col-span-1" htmlFor="numero">Número
                            ...
                            {errors.numero && <span className="md:text-13 tm:text-10 text-red leading-title">{errors.numero.message}</span>}
                        </label>
                        <label className="text-purple tm:text-15 md:text-18 tm:col-span-6 md:col-span-2" htmlFor="bairro">Complemento
                            ...
                            {errors.complemento && <span className="md:text-13 tm:text-10 text-red leading-title">{errors.complemento.message}</span>}
                        </label>
                        <label className="text-purple tm:text-15 md:text-18 tm:col-span-6 md:col-span-2" htmlFor="complemento">Bairro
                            ...
                            {errors.bairro && <span className="md:text-13 tm:text-10 text-red leading-title">{errors.bairro.message}</span>}
                        </label>
                        <label className="text-purple tm:text-15 md:text-18 tm:col-span-6 md:col-span-2" htmlFor="cidade">Cidade
                            ...
                            {errors.cidade && <span className="md:text-13 tm:text-10 text-red leading-title">{errors.cidade.message}</span>}
                        </label>
                        <label className="text-purple tm:text-15 md:text-18 tm:col-span-6 md:col-span-2 appearance-none" htmlFor="estado">Estado
                            ...
                            {errors.estado && <span className="md:text-13 tm:text-10 text-red leading-title">{errors.estado.message}</span>}
                        </label>
                        <div className="tm:col-span-6">
                            <div>
                                ...
                                {errors.aceito && <span className="md:text-13 tm:text-10 text-red leading-title">{errors.aceito.message}</span>}
                            </div>
                            <div>
                            ...
                            <div>
                                <input {...register('autorizo')} type="checkbox" id="autorizo" name="autorizo" />
                        ...
                        {/* Botão de cadastro */}
                        <button className="bg-purple bg-opacity-90 hover:bg-opacity-100 text-white text-15 rounded-full tm:py-6 md:py-13 tm:px-18 md:px-45 outline-none hover:bg-purple hover:text-white hover:shadow-lg transition tm:col-span-6 md:col-span-2"> Cadastrar </button>
                        <HCaptcha
