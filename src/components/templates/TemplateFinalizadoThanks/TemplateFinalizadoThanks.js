                ...
                <div className="tm:container mx-auto grid md:grid-cols-2 tm:grid-cols-1 px-15 place-content-center items-center">
                    ...
                    <div className="md:order-2 tm:order-1">
                        <div className="grid grid-cols-1 gap-22">
                            ...
                            <div className="bg-white rounded-medium text-black text-center text-45 md:text-55 p-13 mt-22 uppercase tracking-widest">Phantom</div>
                            ...
                            <div className="mx-auto">
                                <Link href="https://www.belezanaweb.com.br/phantom-paco-rabanne-eau-de-toilette-perfume-masculino-50ml/?utm_source=puig&utm_medium=amostras-qrcode&utm_campaign=phantom_pacorabanne">
                                    <a target="_blank" className="bg-purple bg-opacity-90 hover:bg-opacity-100 text-white text-center text-18 rounded-full py-13 tm:px-18 md:px-45 outline-none hover:bg-purple hover:text-white hover:shadow-lg transition tm:col-span-6 md:col-span-2">Compre pelo site</a>
                                </Link>
                            </div>
                        </div>
                    </div>
