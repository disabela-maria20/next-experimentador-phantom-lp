...
function TemplatePolitica() {
    return (
        ...
        <ContainerParagraph>
            ...
            <h3 className="text-black md:text-26 tm:text-18 py-38">1. Coleta de Informações</h3>
            ...
            <h3 className="text-black md:text-26 tm:text-18 py-38 uppercase">2. Informações Sensíveis</h3>
            ...
            <h3 className="text-black md:text-26 tm:text-18 py-38 uppercase">2. Como utilizamos e divulgamos informações</h3>
            <p className={pStyle}>Utilizamos e divulgamos as informações que nos disponibiliza conforme descrito no aplicativo. Caso deseje anular e ou excluir qualquer tipo de dado pessoal, entre em contato através do e-mail juridico@adventures.inc</p>
            ...
            <h3 className="text-black md:text-26 tm:text-18 py-38 uppercase">4. Como acessar, modificar ou eliminar as suas informações pessoais</h3>
            <p className={pStyle}>Se pretender rever, corrigir, atualizar, limitar ou eliminar os seus dados pessoais, ou se pretender solicitar uma cópia eletrônica deles para as transmitir para outra empresa (na medida em que estes direitos lhe sejam conferidos pela lei aplicável), entre em contato conosco através do e-mail juridico@adventures.inc</p>
            ...
            <h3 className="text-black md:text-26 tm:text-18 py-38 uppercase">5. Transferência internacional</h3>
            ...
            <h3 className="text-black md:text-26 tm:text-18 py-38 uppercase">6. Segurança</h3>
            ...
            <h3 className="text-black md:text-26 tm:text-18 py-38 uppercase">7. Período de retenção</h3>
            ...
            <h3 className="text-black md:text-26 tm:text-18 py-38 uppercase">Contate-nos</h3>
            ...
            <h3 className="text-black md:text-26 tm:text-18 py-38 uppercase">RECLAMAÇÃO JUNTO DE UMA ENTIDADE REGULADORA
</h3>
