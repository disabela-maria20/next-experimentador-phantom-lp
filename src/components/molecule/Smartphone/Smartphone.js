            ...
            {abrir ?
                <article>
                    ...
                    <div className="py-15 grid-col-50-100">
                        ...
                        <div className="ml-10">
                            ...
                            <p className="text-purple  bg-purple-200 p-15 rounded mt-15 text-15 md:text-18">Sim ou Não</p>
                        </div>
                    </div>
                    <div className="py-15 grid-col-50-100">
                        <div className="bg-black  text-white rounded-medium text-center text-26 w-45 h-45 flex justify-center">
                        ...
                        <div className="ml-10">
                            ...
                            <p className="text-purple  bg-purple-200 p-15 rounded mt-15 text-15 md:text-18 break-words">[Experimentador] Para continuar seu cadastro visite o link:<br /> <span className=" font-medium break-all text-13">https://experimentador.com.br/pacorabanne/oseutokengerado</span></p>
                        </div>
                    </div>
                </article>
                :
                <article>
                    ...
                    <div className="py-15 grid-col-50-100">
                        ...
                        <div className="ml-10">
                            <p className="text-15 md:text-18 text-black">Abra o app, habilite o microfone e diga a seguinte frase de invocação para ser atendido:</p>
                            <p className="text-purple  bg-purple-200 p-15 rounded mt-15 text-15 md:text-18">Alexa. Abrir o Experimentador.</p>
                        </div>
                    </div>
                    <div className="py-15 grid-col-50-100">
                        <div className="bg-black  text-white rounded-medium text-center text-26 w-45 h-45 flex justify-center">
